...
export default function ParfumeInventoryComponent() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold">Parfume Inventory</h1>
        <div className="flex items-center gap-4">
          <Input
            placeholder="Search parfumes..."
            value={searchTerm}
                ...
                <TableRow key={parfume.id}>
                  ...
                  <TableCell className="text-center">
                    <Badge variant="secondary" className={getStatusColor(parfume.status)}>
                      {parfume.status === 'success' ? 'OK' : 'Low Stock'}
                    </Badge>
                  </TableCell>
                  <TableCell className="text-center">
